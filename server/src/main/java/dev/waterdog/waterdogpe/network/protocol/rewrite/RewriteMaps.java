...
public class RewriteMaps {
    ...
    public EntityTracker getEntityTracker() { return entityTracker; }
    public EntityMap getEntityMap() { return entityMap; }
    public BlockMap getBlockMap() { return blockMap; }
    public void setBlockMap(BlockMap blockMap) { this.blockMap = blockMap; }

    public RewriteMaps(WaterdogPlayer player) {
