...
public class OfflineServerChannelInitializer extends ChannelInitializer<Channel> {
    ...
    protected void initChannel(Channel channel) {
        ...
        if (((WaterdogProxyServer) this.proxy).getQueryHandler() != null) {
            channel.pipeline().addAfter(UnconnectedPongEncoder.NAME, QueryHandler.NAME, ((WaterdogProxyServer) this.proxy).getQueryHandler());
        }
