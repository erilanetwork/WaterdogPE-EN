...
public class LoginUpstreamHandler implements BedrockPacketHandler {
    ...
    public PacketSignal handle(RequestNetworkSettingsPacket packet) {
        ...
        if (!this.session.isSubClient()) {
            ((dev.waterdog.waterdogpe.network.connection.peer.ProxiedBedrockPeer) this.session.getPeer()).setCompression(this.compression);
        }
        return PacketSignal.HANDLED;
    }
    ...
    public PacketSignal handle(LoginPacket packet) {
        ...
        try {
            ...
            PlayerAuthenticatedEvent loginEvent = new PlayerAuthenticatedEvent(dev.waterdog.waterdogpe.player.WaterdogPlayer.class, loginData, (InetSocketAddress) this.session.getSocketAddress());
            ...
            this.player = (WaterdogPlayer) loginEvent.getBaseClass().getConstructor(ProxyServer.class, BedrockServerSession.class, CompressionType.class, LoginData.class)
