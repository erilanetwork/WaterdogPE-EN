...
public class WaterdogProxyConfig extends YamlConfig implements ProxyConfig {
    ...
    public WaterdogProxyConfig(File file) {
    ...
    public String getSubMotd() { return subMotd; }
    public void setSubMotd(String subMotd) { this.subMotd = subMotd; }
    ...
    public void setBindAddress(InetSocketAddress bindAddress) { this.bindAddress = bindAddress; }
    ...
    public Map<String, String> getForcedHosts() { return forcedHosts; }
    public void setForcedHosts(Map<String, String> forcedHosts) { this.forcedHosts = forcedHosts; }
    public ServerList getServerList() { return serverList; }
    public void setServerList(ServerList serverList) { this.serverList = serverList; }
    public NetworkSettings getNetworkSettings() { return networkSettings; }
    public void setNetworkSettings(NetworkSettings networkSettings) { this.networkSettings = networkSettings; }
    public Map<String, List<String>> getPlayerPermissions() { return playerPermissions; }
    public void setPlayerPermissions(Object2ObjectOpenHashMap<String, List<String>> playerPermissions) { this.playerPermissions = playerPermissions; }
    ...
    public boolean isUpstreamEncryption() { return upstreamEncryption; }
    public void setUpstreamEncryption(boolean upstreamEncryption) { this.upstreamEncryption = upstreamEncryption; }
    ...
    public void setAdditionalPorts(List<Integer> additionalPorts) { this.additionalPorts = additionalPorts; }
    public String getJoinHandler() { return joinHandler; }
    public void setJoinHandler(String joinHandler) { this.joinHandler = joinHandler; }
    public String getReconnectHandler() { return reconnectHandler; }
    public void setReconnectHandler(String reconnectHandler) { this.reconnectHandler = reconnectHandler; }
    public boolean useLoginExtras() { return useLoginExtras; }
    public void setUseLoginExtras(boolean useLoginExtras) { this.useLoginExtras = useLoginExtras; }
    public boolean useCertificatePayload() { return useCertificatePayload; }
    public void setUseCertificatePayload(boolean useCertificatePayload) { this.useCertificatePayload = useCertificatePayload; }
    public boolean isReplaceUsernameSpaces() { return replaceUsernameSpaces; }
    public void setReplaceUsernameSpaces(boolean replaceUsernameSpaces) { this.replaceUsernameSpaces = replaceUsernameSpaces; }
    public boolean enableQuery() { return enableQuery; }
    public void setEnableQuery(boolean enableQuery) { this.enableQuery = enableQuery; }
    public boolean useFastTransfer() { return useFastTransfer; }
    public void setUseFastTransfer(boolean useFastTransfer) { this.useFastTransfer = useFastTransfer; }
    public boolean injectCommands() { return injectCommands; }
    public void setInjectCommands(boolean injectCommands) { this.injectCommands = injectCommands; }
    ...
    public int getUpstreamCompression() { return upstreamCompression; }
    public void setUpstreamCompression(int upstreamCompression) { this.upstreamCompression = upstreamCompression; }
    public int getDownstreamCompression() { return downstreamCompression; }
    public void setDownstreamCompression(int downstreamCompression) { this.downstreamCompression = downstreamCompression; }
    public boolean enableEducationFeatures() { return enableEducationFeatures; }
    public void setEnableEducationFeatures(boolean enableEducationFeatures) { this.enableEducationFeatures = enableEducationFeatures; }
    public boolean enableResourcePacks() { return enableResourcePacks; }
    public void setEnableResourcePacks(boolean enableResourcePacks) { this.enableResourcePacks = enableResourcePacks; }
    public boolean isOverwriteClientPacks() { return overwriteClientPacks; }
    public void setOverwriteClientPacks(boolean overwriteClientPacks) { this.overwriteClientPacks = overwriteClientPacks; }
    public boolean isForceServerPacks() { return forceServerPacks; }
    public void setForceServerPacks(boolean forceServerPacks) { this.forceServerPacks = forceServerPacks; }
    public int getPackCacheSize() { return packCacheSize; }
    public void setPackCacheSize(int packCacheSize) { this.packCacheSize = packCacheSize; }
    public int getIdleThreads() {
        return this.defaultIdleThreads < 1 ? Runtime.getRuntime().availableProcessors() : this.defaultIdleThreads;
    }
    public void setDefaultIdleThreads(int defaultIdleThreads) { this.defaultIdleThreads = defaultIdleThreads; }
    public boolean isEnableAnonymousErrorReporting() { return enableAnonymousErrorReporting; }
    public void setEnableAnonymousErrorReporting(boolean enableAnonymousErrorReporting) { this.enableAnonymousErrorReporting = enableAnonymousErrorReporting; }
}
