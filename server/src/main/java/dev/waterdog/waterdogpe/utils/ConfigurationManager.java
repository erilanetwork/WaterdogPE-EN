...
import dev.waterdog.waterdogpe.utils.config.proxy.WaterdogProxyConfig;
...
public class ConfigurationManager {
    ...
    public void loadProxyConfig() throws InvalidConfigurationException {
        ...
        WaterdogProxyConfig config = new WaterdogProxyConfig(configFile);
        config.init();
    ...
    public <T> T loadServiceProvider(String providerName, Class<T> clazz, WaterdogPluginManager pluginManager) {
