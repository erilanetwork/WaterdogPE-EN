...
public class WaterdogPackManager implements dev.waterdog.waterdogpe.packs.PackManager {
    ...
    public Map<UUID, ResourcePack> getPacks() { return packs; }
    public Map<String, ResourcePack> getPacksByIdVer() { return packsByIdVer; }
    @Override
    public ResourcePacksInfoPacket getPacksInfoPacket() { return packsInfoPacket; }
    public ResourcePackStackPacket getStackPacket() { return stackPacket; }

    public WaterdogPackManager(ProxyServer proxy) {
        this.proxy = proxy;
    }
