...
import dev.waterdog.waterdogpe.packs.WaterdogPackManager;
import dev.waterdog.waterdogpe.player.WaterdogPlayerManager;
import dev.waterdog.waterdogpe.player.ProxiedPlayer;
import dev.waterdog.waterdogpe.plugin.WaterdogPluginManager;
import dev.waterdog.waterdogpe.scheduler.WaterdogSchedulerImpl;
import dev.waterdog.waterdogpe.security.WaterdogSecurityManager;
...
public class WaterdogProxyServer implements ProxyServer {
    public static WaterdogProxyServer getInstance() { return instance; }

    public Path getDataPath() { return dataPath; }
    public Path getPluginPath() { return pluginPath; }

    public MainLogger getLogger() { return logger; }

    public ConfigurationManager getConfigurationManager() { return configurationManager; }
    public WaterdogSchedulerImpl getScheduler() { return scheduler; }
    public WaterdogPlayerManager getPlayerManager() { return playerManager; }
    public WaterdogPluginManager getPluginManager() { return pluginManager; }
    public EventManager getEventManager() { return eventManager; }
    public WaterdogPackManager getPackManager() { return packManager; }

    public ServerInfoMap getServerInfoMap() { return serverInfoMap; }

    public QueryHandler getQueryHandler() { return queryHandler; }

    public CommandMap getCommandMap() { return commandMap; }

    public WaterdogSecurityManager getSecurityManager() { return securityManager; }

    public IReconnectHandler getReconnectHandler() { return reconnectHandler; }
    public void setReconnectHandler(IReconnectHandler reconnectHandler) { this.reconnectHandler = reconnectHandler; }
    public IJoinHandler getJoinHandler() { return joinHandler; }
    public void setJoinHandler(IJoinHandler joinHandler) { this.joinHandler = joinHandler; }
    public IForcedHostHandler getForcedHostHandler() { return forcedHostHandler; }
    public void setForcedHostHandler(IForcedHostHandler forcedHostHandler) { this.forcedHostHandler = forcedHostHandler; }
    
    public EventLoopGroup getWorkerEventLoopGroup() { return workerEventLoopGroup; }
    public int getCurrentTick() { return currentTick; }

    private static WaterdogProxyServer instance;
    ...
    private final WaterdogSchedulerImpl scheduler;
    private final WaterdogPlayerManager playerManager;
    private final WaterdogPluginManager pluginManager;
    private final EventManager eventManager;
    private final WaterdogPackManager packManager;

    private final ServerInfoMap serverInfoMap;
    ...
    private final WaterdogSecurityManager securityManager;
    ...
    public WaterdogProxyServer(MainLogger logger, String filePath, String pluginPath) throws InvalidConfigurationException {
        instance = this;
        ProxyServer.setInstance(this);
        ServerInfoType.setupBedrock(BedrockServerInfo::new);
        this.serverInfoMap = new ServerInfoMap();
        this.logger = logger;
        ...
        this.pluginManager = new WaterdogPluginManager(this);
        this.scheduler = new WaterdogSchedulerImpl(this);
        this.playerManager = new WaterdogPlayerManager(this);
        this.eventManager = new EventManager(this);
        this.packManager = new WaterdogPackManager(this);
        this.securityManager = new WaterdogSecurityManager(this);
