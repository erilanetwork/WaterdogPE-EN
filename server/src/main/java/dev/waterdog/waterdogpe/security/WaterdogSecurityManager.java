...
public class WaterdogSecurityManager implements dev.waterdog.waterdogpe.security.SecurityManager {
    ...
    public ConnectionThrottle getConnectionThrottle() { return connectionThrottle; }
    public ConnectionThrottle getLoginThrottle() { return loginThrottle; }
    ...
    public SecurityListener getListener() { return listener; }
    public void setListener(SecurityListener listener) { this.listener = listener; }

    public WaterdogSecurityManager(ProxyServer proxy) {
        this.proxy = proxy;
    ...
    public void onConnectionError(SocketAddress address, Throwable cause) {
        if (cause != null) {
            logger.error("{} Exception caught in bedrock connection", address, cause);
        }
