 ...
 */
public class WaterdogPlayer implements ProxiedPlayer {
    ...
    public boolean canRewrite() { return canRewrite; }
    public void setCanRewrite(boolean canRewrite) { this.canRewrite = canRewrite; }
    public boolean hasUpstreamBridge() { return hasUpstreamBridge; }
    public void setHasUpstreamBridge(boolean hasUpstreamBridge) { this.hasUpstreamBridge = hasUpstreamBridge; }
    /**
    ...
    public void setAcceptResourcePacks(boolean acceptResourcePacks) { this.acceptResourcePacks = acceptResourcePacks; }
    public boolean acceptItemComponentPacket() { return acceptItemComponentPacket; }
    public void setAcceptItemComponentPacket(boolean acceptItemComponentPacket) { this.acceptItemComponentPacket = acceptItemComponentPacket; }
    public Collection<PluginPacketHandler> getPluginPacketHandlers() { return pluginPacketHandlers; }

    public WaterdogPlayer(ProxyServer proxy, BedrockServerSession session, CompressionType compression, LoginData loginData) {
        this.proxy = proxy;
    ...
    public void disconnect(String reason) {
        this.disconnect((CharSequence) reason);
    }
    ...
    public void addPermission(String permission) {
        this.addPermission(new Permission(permission, true));
    }
    ...
    public dev.waterdog.waterdogpe.logger.Logger getLogger() {
