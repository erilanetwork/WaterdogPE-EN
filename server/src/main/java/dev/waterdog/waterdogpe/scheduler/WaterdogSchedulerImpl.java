...
public class WaterdogSchedulerImpl implements dev.waterdog.waterdogpe.scheduler.WaterdogScheduler {

    @Getter
    private static WaterdogSchedulerImpl instance;
    ...
    public WaterdogSchedulerImpl(ProxyServer proxy) {
        if (instance != null) {
    ...
    public void cancelTask(int taskId) {
        TaskHandler<?> handler = this.taskHandlerMap.get(taskId);
        if (handler != null) {
            handler.cancel();
        }
    }
