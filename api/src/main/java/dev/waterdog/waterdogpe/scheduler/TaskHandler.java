...
public class TaskHandler<T extends Runnable> {
    ...
    public int getLastRunTick() { return lastRunTick; }
    public int getNextRunTick() { return nextRunTick; }
    public void setNextRunTick(int nextRunTick) { this.nextRunTick = nextRunTick; }
    ...
    public void onRun(int currentTick) {
        ...
        try {
            ...
            if (this.task instanceof Task) {
                ...
                ProxyServer.getInstance().getLogger().error("Exception while running task!", t);
            }
        }
    }
